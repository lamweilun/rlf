...
namespace rlf::Node {
    ...
    void UISliderNode::updateImpl() {
        ...
        auto mIsHoveringButton = CheckCollisionPointRec(mouseWorldPos, buttonRec);
        ...
        if (mIsHoveringButton) {
            ...
            bool const isHoveringBackground = CheckCollisionPointRec(mouseWorldPos, backgroundRec);
